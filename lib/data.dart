...
class Game {
  ...
  List<GameImage> image = [];
  String description;
  String studio;

  // un-named constructor
  Game(this.title, this.coverImage, this.image, this.description, this.studio);

  // named-constructor
  Game.games(this.title, this.coverImage, this.description, this.studio);

  Game.featuredGames(
      this.title, this.coverImage, this.description, this.studio);
}
